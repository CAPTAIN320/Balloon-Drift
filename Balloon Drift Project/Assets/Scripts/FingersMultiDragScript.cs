...
{
    [AddComponentMenu("Fingers Gestures/Multi Drag")]
    public class FingersMultiDragScript : MonoBehaviour
    {
        ...
        private void StartDrag(GestureTouch touch)
        {
            ...
            Vector2 worldPos = Camera.main.ScreenToWorldPoint(new Vector3(touch.X, 0f, 0.0f));
